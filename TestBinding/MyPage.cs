...
namespace TestBinding
{
	public class MyPage : ContentPage
	{
		public MyPage()
		{
			...
			Label l = new Label() { Text = "You can TAP on Description, Trash or on QTY... there are two different answers because Description raise a SelectedItem, Trash and Qty raise a TapGestureRecognizer. If you delete all rows, a Label appears." };
			...
			lv.ItemTemplate = new DataTemplate(() =>
			{
				...
				return new ViewCell { View = slView};
			});
